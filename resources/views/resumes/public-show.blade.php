...
<body class="bg-gray-100">
    ...
    {{-- The header is kept inside a container for a neat, centered look --}}
        ...
        <div class="max-w-4xl mx-auto bg-white p-4 rounded-lg shadow-md mb-6 flex justify-between items-center">
            ...
            <div>
                ...
                <div class="mt-1 flex items-center text-sm text-gray-500">
                    ...
                    <span>This resume has been viewed {{ $viewCount }} {{ Str::plural('time', $viewCount) }}.</span>
                </div>
            </div>
    ...
    {{-- The resume content is now OUTSIDE the container, allowing it to be full-width --}}
    <div class="bg-white shadow-lg mx-auto">
        {!! $previewHtml !!}
    </div>

    <!-- ============================================= -->
    <!-- ADDED: "Go to Homepage" Button Section        -->
    <!-- ============================================= -->
