...
<head>
    ...
    <title>Resume: <?php echo e($resume->name); ?></title>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 sm:p-8">
        <div class="max-w-4xl mx-auto bg-white p-4 rounded-lg shadow-md mb-6 flex justify-between items-center">
            ...
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Viewing Resume: <span class="text-red-800"><?php echo e($resume->name); ?></span></h1>
                ...
                <div class="mt-1 flex items-center text-sm text-gray-500">
                    ...
                    <span>Viewed <?php echo e($viewCount); ?> <?php echo e(Str::plural('time', $viewCount)); ?>.</span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <form action="<?php echo e(route('resumes.processDownload', $resume)); ?>" method="POST" target="_blank" class="flex items-center space-x-2">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\wamp64\www\CS262-Frontend-ResumeBuilder-Ver2\resources\views/resumes/public-show.blade.php ENDPATH**/ ?>