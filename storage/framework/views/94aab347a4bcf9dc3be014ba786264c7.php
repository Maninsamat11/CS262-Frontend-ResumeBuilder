...
<head>
    ...
    <title><?php echo e(config('app.name', 'ResuLink')); ?></title>
                ...
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4 sm:justify-center lg:justify-start">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('templates.index')); ?>" class="bg-gradient-to-r from-red-600 to-red-800 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center">
                                Create Resume Now
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-red-600 to-red-800 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center">
                                Start Building Free
                            </a>
                        <?php endif; ?>
...
<section class="py-16 bg-gray-100 border-t border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <form action="<?php echo e(route('resumes.viewFromLink')); ?>" method="POST" class="flex flex-col sm:flex-row items-stretch justify-center max-w-xl mx-auto">
                <?php echo csrf_field(); ?>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('templates.index')); ?>" class="bg-gradient-to-r from-red-600 to-red-800 text-white px-10 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 inline-block">
                    Create Your Resume Now
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-red-600 to-red-800 text-white px-10 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 inline-block">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex items-center space-x-3 mb-4 md:mb-0">
                    ...
                    <span class="text-xl font-bold"><?php echo e(config('app.name', 'ResuLink')); ?></span>
                </div>
...
</html><?php /**PATH C:\wamp64\www\CS262-Frontend-ResumeBuilder-Ver2\resources\views/home.blade.php ENDPATH**/ ?>