...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div class="w-full max-w-4xl bg-white shadow-lg rounded-xl">
            ...
            <div x-data="{
                    shareUrl: '<?php echo e($resume->share_url ? route('resumes.public.show', ['shareUrl' => $resume->share_url]) : ''); ?>',
                    copyText: 'Copy',
                    downloadMessage: '',
                    copyToClipboard() {
                ...
                <div class="border-b-2 border-gray-200 pb-4 mb-8">
                    ...
                    <p class="mt-1 text-gray-600">Manage public access and download your resume: <span class="font-semibold"><?php echo e($resume->name); ?></span></p>
                </div>
                ...
                <form action="<?php echo e(route('resumes.share.update', $resume)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-end items-center space-x-4 mt-8 pt-6 border-t border-gray-200">
                        <a href="<?php echo e(route('dashboard')); ?>" class="bg-gray-200 text-gray-800 font-bold py-3 px-8 rounded-lg hover:bg-gray-300">Close</a>
                        <?php if($resume->share_url): ?>
                ...
                <div class="border-t-2 border-gray-200 mt-8 pt-6">
                    ...
                    <form action="<?php echo e(route('resumes.processDownload', $resume)); ?>" method="POST"
                        target="_blank" 
...
<?php endif; ?><?php /**PATH C:\wamp64\www\CS262-Frontend-ResumeBuilder-Ver2\resources\views/resumes/share.blade.php ENDPATH**/ ?>