...
<?php $component->withAttributes([]); ?>
 ...
 <?php echo app('Illuminate\Foundation\Vite')('resources/css/tutorial.css'); ?>
 <div class="py-12">
                ...
                <div class="container">
                            ...
                            <div class="timeline-item">
                                <div class="timeline-content">
                                    ...
                                    <div class="example-box">
                                        <h4>Example:</h4>
                                        <p><strong><?php echo e($user->name ?? 'John Smith'); ?></strong><br>
                                        <?php echo e($user->phone ?? '(555) 123-4567'); ?> | <?php echo e($user->email ?? 'john.smith@email.com'); ?><br>
                                        <?php echo e($user->linkedin ?? 'linkedin.com/in/johnsmith'); ?> | <?php echo e($user->location ?? 'New York, NY'); ?></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tutorial-section" id="formatting">
                        ...
                        <div class="example-box">
                            ...
                            <p>Choose from our <?php echo e(count($templates)); ?> professionally designed templates that are both ATS-friendly and visually appealing.</p>
                            <a href="<?php echo e(route('templates.index')); ?>" class="btn btn-sm btn-primary">View Templates</a>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="tutorial-section">
                        ...
                        <div class="progress-container">
                            <div class="step-title">Step <?php echo e($index + 1); ?>: <?php echo e($step['title']); ?></div>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: <?php echo e($step['progress']); ?>%"></div>
                            </div>
                            <div class="step-description"><?php echo e($step['description']); ?></div>
                        </div>
                    ...
                    <div class="cta-section">
                        ...
                        <a href="<?php echo e(route('templates.index')); ?>" class="btn-cta btn-secondary">View Templates</a>
                    </div>
                </div>
</div>
        </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\CS262-Frontend-ResumeBuilder-Ver2\resources\views/tutorial.blade.php ENDPATH**/ ?>