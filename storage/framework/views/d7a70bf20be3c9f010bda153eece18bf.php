            ...
            <?php if($templates->isNotEmpty()): ?>
                ...
                <!-- <div class="mb-8 flex justify-center">
                    <div class="bg-white rounded-full px-6 py-3 shadow-md border border-gray-200">
                        <span class="text-gray-600 font-medium"><?php echo e($templates->count()); ?> Professional Templates Available</span>
                    </div>
                </div> -->
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-gray-100">
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                <div class="aspect-[3/4] bg-gray-100 relative overflow-hidden">
                                    <img src="<?php echo e($template->template_url); ?>" 
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-center pb-6">
                                    ...
                                    <div class="flex space-x-3 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="previewTemplate('<?php echo e($template->template_url); ?>', '<?php echo e($template->name); ?>')">
                                        ...
                                        <!-- Use Template Button -->
                                        <form method="POST" action="<?php echo e(route('resumes.store')); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="template_id" value="<?php echo e($template->template_id); ?>">
                                            <button type="submit" 
...
<?php endif; ?><?php /**PATH C:\wamp64\www\CS262-Frontend-ResumeBuilder-Ver2\resources\views/templates/index.blade.php ENDPATH**/ ?>